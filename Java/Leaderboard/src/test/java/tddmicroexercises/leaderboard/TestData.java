...
public class TestData {
    ...
    public static SelfDrivingCar selfDrivingCarNamedLikeDriver3;
    ...
    public static Race raceWithNameCollision;

    public static Leaderboard sampleLeaderboard1;
    public static Leaderboard sampleLeaderboard2;
    public static Leaderboard leaderboardWithNameCollision;
    ...
    static {
        ...
        selfDrivingCarNamedLikeDriver3 = new SelfDrivingCar("Sebastian Vettel", "DE");
        ...
        race4 = new Race("Fictional Grand Prix 1", driver1, driver2, selfDrivingCar);
        race5 = new Race("Fictional Grand Prix 2", selfDrivingCar, driver2, driver1);
        selfDrivingCar.setAlgorithmVersion("1.3");
        race6 = new Race("Fictional Grand Prix 3", driver2, driver1, selfDrivingCar);
        raceWithNameCollision = new Race("Race with name collision", driver3, selfDrivingCarNamedLikeDriver3);

        sampleLeaderboard1 = new Leaderboard(race1, race2, race3);
        sampleLeaderboard2 = new Leaderboard(race4, race5, race6);
        leaderboardWithNameCollision = new Leaderboard(raceWithNameCollision);
    }
}
